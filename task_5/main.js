...
// Уважаемый ментор, подскажите пожалуйста по данному заданию, не могу корректно вставить в код информацию, чтобы данные не являлись чилсом
//и почему-то код не выводит картину
//Спасибо!
